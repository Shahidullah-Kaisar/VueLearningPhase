...
const handleSubmit = async () => {
  ...
  try {
    ...
    router.push(`/jobs/${response.data.id}`); //server response এ response.data.id পেলে তুমি user কে ওই specific job details page এ পাঠাচ্ছো।
...
<template>
  <section class="bg-green-50">
    <div class="container m-auto max-w-4xl py-24">
      <div
        class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border border-green-500 m-4 md:m-0"
      >
